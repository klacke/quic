...
static ErlNifFunc nif_funcs[] = {
   ...
   */
  // clang-format off
  { "open_lib", 1, openLib, 1 },
  { "close_lib", 0, closeLib, 1 },
  { "reg_open", 0, registration, 1 },
  { "reg_open", 1, registration, 1 },
  { "reg_close", 0, deregistration, 1 },
  { "listen", 2, listen2, 1},
  { "close_listener", 1, close_listener1, 1},
  { "open_connection", 0, open_connection0, 1},
  { "async_connect", 3, async_connect3, 1},
  { "async_accept", 2, async_accept2, 1},
  { "async_handshake", 1, async_handshake_1, 1},
  { "async_shutdown_connection", 3, shutdown_connection3, 1},
  { "async_accept_stream", 2, async_accept_stream2, 1},
  { "start_stream", 2, async_start_stream2, 1},
  { "send", 3, send3, 1},
  { "csend", 4, csend4, 1},
  { "recv", 2, recv2, 1},
  { "send_dgram", 3, send_dgram, 1},
  { "async_shutdown_stream", 3, shutdown_stream3, 1},
  { "sockname", 1, sockname1, 1},
  { "getopt", 3, getopt3, 1},
  { "setopt", 4, setopt4, 1},
  { "controlling_process", 2, controlling_process, 1},
  /* for DEBUG */
